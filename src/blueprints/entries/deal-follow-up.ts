...
export const dealFollowUpBlueprint = {
	slug: 'deal-follow-up',
	...
	contentTemplates: [
		{
			...
			emailContent: {
				...
				body: [
					...
					bullets('recap-next', [
						bulletItem('recap-stage', [text('Current stage: '), variable('deal_stage')]),
						bulletItem('recap-step', [
							text('Next step: '),
							variable('next_step'),
							text(' on '),
	...
	resolutionRules: [
		{ id: 'procurement-stage', templateId: 'procurement-follow-up', answers: { deal_stage: 'procurement' } },
		{ id: 'procurement-recipient', templateId: 'procurement-follow-up', answers: { recipient: 'procurement_team' } },
		{ id: 'proposal-ask', templateId: 'proposal-review', answers: { primary_ask: 'review_proposal' } },
		{ id: 'proposal-committee', templateId: 'proposal-review', answers: { deal_stage: 'proposal', recipient: 'committee' } },
		{ id: 'skipped-stage', templateId: 'conversation-recap', answers: { deal_stage: BLUEPRINT_SETUP_SKIPPED_ANSWER } },
		{ id: 'skipped-recipient', templateId: 'conversation-recap', answers: { recipient: BLUEPRINT_SETUP_SKIPPED_ANSWER } },
		{ id: 'skipped-ask', templateId: 'conversation-recap', answers: { primary_ask: BLUEPRINT_SETUP_SKIPPED_ANSWER } },
		{ id: 'default', templateId: 'conversation-recap', answers: {} }
	],
	showInGallery: true,
	sortOrder: 20,
	status: 'active'
