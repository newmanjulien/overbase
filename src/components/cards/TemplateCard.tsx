...
import {
  ...
  DEFAULT_GRADIENT,
  type GradientKey,
} from "@/app/dashboard/templates/gradients";
...
export function TemplateCard({
  ...
  return (
    <div
      className="rounded-3xl border border-gray-200/60 overflow-hidden cursor-pointer hover:shadow-md transform transition-all duration-200"
      onClick={onUse}
    >
