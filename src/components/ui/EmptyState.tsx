...
export function EmptyState({
  ...
  return (
    ...
    >
      {/* Icon bubble */}
      <div className="w-20 h-20 bg-gray-200/60 rounded-full flex items-center justify-center mb-6">
        <div className="w-10 h-10 text-gray-600 flex items-center justify-center">
