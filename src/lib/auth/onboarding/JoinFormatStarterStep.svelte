<script lang="ts">
	...
	import FormatStarterCardArtwork from '$lib/features/format-starters/gallery/FormatStarterCardArtwork.svelte';
	...
	<div class="w-full max-w-120 text-center">
		...
		<div class="mt-10 flex justify-center">
			<div class="w-full max-w-70">
					<a
						href={resolve(APP_DYNAMIC_ROUTE_IDS.createFormat, { formatStarterSlug: formatStarter.slug })}
