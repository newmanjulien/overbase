...
export const topOfMindFormatStarter = defineFormatStarter({
  ...
  startingPointSelection: {
    kind: "guided",
    intro:
      "Choose the implementation context so the plan starts from the right operating model.",
    questions: [
      {
        id: "phase",
  ...
  startingPoints: [
    {
      ...
      emailContent: {
        ...
        attachment: seededSpreadsheetAttachment(
          "Implementation kickoff plan.xlsx",
          [
            [
              cell("Milestone"),
              cell("Owner"),
