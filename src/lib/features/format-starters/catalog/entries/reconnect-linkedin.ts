  ...
  startingPointSelection: {
    ...
    infoBar: {
      ...
      content: [
        {
          kind: "text",
          text: "This is a simple format designed to only use public data",
        },
      ],
    },
    questions: [
  ...
  startingPoints: [
    ...
    },
    {
      ...
      emailContent: {
        ...
        body: [
          paragraph("linkedin-senior-greeting", [
            text("Hey "),
            variable("assistant"),
            text(","),
          ]),
          paragraph("linkedin-senior-signal", [
            ...
            text(
              "'s contact Ajay Agrawal just started a new role at Mastercard (",
            ),
            variable("link"),
            text(")."),
          ]),
