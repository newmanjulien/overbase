<script lang="ts">
	...
	type Props = {
		...
		canSave: boolean;
		onLikedValueChange: (value: string) => void;
		...
		<div class="flex min-h-0 flex-1 flex-col gap-4">
			<section class="flex min-h-0 flex-1 flex-col">
				...
				<textarea
					...
					placeholder="What worked well in this email?"
			...
			<InfoBar label="Next step:" class="shrink-0">
				Train the AI by telling us what you like and don't like about this specific email
			</InfoBar>
		</div>
	</div>
