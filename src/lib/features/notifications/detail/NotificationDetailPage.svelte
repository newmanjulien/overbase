<script lang="ts">
	...
	import NotificationEmailFeedbackEmptyState from './NotificationEmailFeedbackEmptyState.svelte';
	import NotificationEmailFeedbackPanel from './NotificationEmailFeedbackPanel.svelte';
	import NotificationEmailPreviewPanel from './NotificationEmailPreviewPanel.svelte';
	...
	} from './notification-detail-state.svelte';
	import { NOTIFICATION_DETAIL_SPLIT } from './notification-detail-layout';
	import { areNotificationRulesFilled } from './notification-detail-rules';
	import { type NotificationEmailItem } from './notification-detail-types';
