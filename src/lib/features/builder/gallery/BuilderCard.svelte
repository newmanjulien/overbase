	...
	<div class="px-0.5 pt-1.5">
		<div class="flex min-w-0 items-center gap-1.5">
			...
			{#if builder.mode === 'public-data'}
				<HelpTooltip
					id={`builder-card-${builder.slug}-rules-info`}
					text="This builder creates an email format that only uses public data and doesn't use any of your internal data"
					ariaLabel={`About ${builder.title}`}
