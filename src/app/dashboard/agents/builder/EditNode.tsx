...
export default function EditNode({ node, onSave, onClose }: EditingNodeProps) {
  ...
  return (
    <Card
      className="h-full flex flex-col overflow-hidden p-0 rounded-xl shadow-sm hover:shadow-md transition-shadow transition-all duration-200"
    ...
    >
      ...
      {/* Content */}
      <div className="flex-1 overflow-y-auto p-3 pt-0 space-y-4 bg-white no-scrollbar">
        {/* Title */}
        ...
        <div className="flex items-center justify-start mt-2 gap-2">
          <Button
            ...
            variant="ghost"
            size="sm"
            leadingIcon={<Paperclip className="h-3 w-3" strokeWidth={1.5} />}
            className="h-7 px-2 text-xs text-gray-600 border border-gray-200/60 hover:bg-gray-50 hover:text-gray-800"
          >
            Attach files
          </Button>
          ...
          <Button
            ...
            variant="ghost"
            size="sm"
            leadingIcon={<ImageIcon className="h-3 w-3" strokeWidth={1.5} />}
            className="h-7 px-2 text-xs text-gray-600 border border-gray-200/60 hover:bg-gray-50 hover:text-gray-800"
          >
            Attach images
          </Button>
