...
function buildRefinementUserPrompt(params: {
	draft: EmailDraft;
	recentEvents: WhitespaceFinderRefinementParams['recentEvents'];
}) {
	return [
...
async function streamEmailDraftRefinementTurn(params: {
	systemPrompt: string;
	userPrompt: string;
	transcript: WhitespaceFinderRefinementParams['transcript'];
	draft: EmailDraft;
	handlers: WhitespaceFinderRefinementParams['handlers'];
...
export async function createWhitespaceFinderInitialDraft(params: WhitespaceFinderInitialDraftParams) {
	const prompt = buildWhitespaceFinderInitialDraftPrompt(params);
