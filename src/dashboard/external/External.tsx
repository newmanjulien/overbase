...
//             <span>
//               Add and manage external partners then connect them to your
//               workflows.{" "}
//             </span>
//             <a
//               href="#"
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex flex-col leading-tight max-w-[calc(100%-180px)]">
              ...
              <h2 className="text-gray-600 text-sm font-normal mt-1">
                Add external partners so you can reference them in workflows and
                so your AI can collaborate with them on your tasks.{" "}
                <a
                  href="#"
                  className="inline-flex items-center text-[#1A69FF] hover:text-[#1A69FF]/80 ml-1 transition-colors"
                >
            ...
            {/* Right: add external partner button */}
            <Button
              onClick={() => {
                /* does nothing */
              }}
