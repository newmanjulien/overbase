...
export const builderBlueprints = [
  ...
  },
  {
    ...
    description:
      "Receive a report 3 months before renewals with new policies each client could buy",
  ...
  },
  {
    ...
    description:
      "Receive an email when a client might have a legal issue they need your help with",
  ...
  },
  {
    ...
    title: "Cross-selling",
    description:
      "Receive an email when your partner has a client you could be selling to",
  ...
  },
  {
    ...
    description:
      "Explain the format of the emails you want your team to receive",
...
export const builderGuides = [
  ...
  {
    blueprintSlug: "whitespace-finder",
    intro:
      "Let's build your Whitespace finder notification. I just have a few quick questions.",
    questions: [
      {
        id: "renewal-window",
        type: "choice",
  ...
  {
    blueprintSlug: "reasons-to-connect",
    intro:
      "Let's build your Reasons to connect notification. I just have a few quick questions.",
    questions: [
      {
        id: "legal-signal",
        type: "choice",
  ...
  {
    blueprintSlug: "cross-selling",
    intro:
      "Let's build your Cross-selling notification. I just have a few quick questions.",
    questions: [
      {
        id: "partner-signal",
        type: "choice",
...
export const emailTemplateGroups = [
  {
    ...
    description:
      "Notifications that help a relationship owner follow up with clients or prospects.",
    questionGuidance:
  ...
  },
  {
    ...
    label: "Pipeline risk",
    description:
      "Notifications that surface stalled, risky, or changing commercial opportunities.",
    questionGuidance:
  ...
  },
  {
    ...
    label: "Market signal",
    description:
      "Notifications triggered by outside events that create a timely reason to connect.",
    questionGuidance:
  ...
  },
  {
    ...
    description:
      "Notifications that summarize exceptions, misses, or recurring team workflow changes.",
    questionGuidance:
...
export const emailTemplates = [
  {
    ...
    description:
      "A weekly email listing clients who have not received a promised follow-up.",
    matchSignals: [
  ...
  },
  {
    ...
    description:
      "A pipeline alert when an opportunity has not moved for a defined number of days.",
    matchSignals: [
      "stalled deals",
  ...
  },
  {
    ...
    description:
      "A timely reason-to-connect email when a watched company announces a leadership change.",
    matchSignals: [
      "leadership change",
      "new executive",
      "client news",
  ...
  },
  {
    ...
    description:
      "An alert when a new regulatory update affects watched clients or industries.",
    matchSignals: [
      "regulatory update",
      "compliance change",
      "industry alert",
    ...
    emailDraft: {
      ...
      body: [
        ...
        },
        {
          type: "bullets",
          items: [
            "Affected industry or jurisdiction",
            "Relevant clients",
